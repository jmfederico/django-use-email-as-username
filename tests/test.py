...
class TestAppGeneration(TestCase):
    ...
    def test_custom_app_is_created(self):
        ...
        with mock.patch.object(TemplateCommand, 'validate_name', validate_name):
            ...
            call_command('create_custom_user_app', 'custom_user_test', directory=self.test_dir)
            custom_user_test_path = os.path.dirname(os.path.abspath(__file__)) + '/apps/custom_user_test'
...
class TestUserManager(TestCase):
    ...
    def test_email_is_normalized(self):
        ...
        User.objects.normalize_email = mock.MagicMock(wraps=User.objects.normalize_email)
